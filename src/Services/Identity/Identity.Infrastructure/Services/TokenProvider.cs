...
public class TokenProvider(IOptions<TokenSettings> settings)
    : ITokenProvider
{
    private readonly TokenSettings _settings = settings.Value;

    public Token GenerateAccessToken(User user, IEnumerable<string> roles)
    {
